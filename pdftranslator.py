...
class PDFTranslator:
    def __init__(self):
        settings = Settings()
        # DeepLを操作するためのWebDriver
        self.__deepLManager = DeepLManager(settings.settings["main_window"]["str_web_browser"])
    ...
    def PDFTextExtract(self, filename, force_ignore_start_condition=False, force_ignore_end_condition=False):
        """
